        ...
        <div class="container container-index">
            <div class="container container-texto">
                ...
                <div class="container container-home centralizar">
                    ...
                    <a href="CadastroUsuario.jsp" class="btn btn-primary btn mb-2" id="createUser">Cadastrar Usuário</a>
                    ...
                    <hr><h4>EDITAR</h4><hr>
                    <a href="EditarUsuario.jsp" class="btn btn-primary btn mb-2" id="editUser">Editar Usuário</a>
