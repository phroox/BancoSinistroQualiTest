                ...
                <div class="container container-forms">
                    ...
                    <form method="POST" action="CadastrarConta" >
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="accountName" name="nome_conta" required="required" maxlength="20"  placeholder="">
                            <span style="font-size: 0.8rem;">Ex: Conta Nubank</span>
                        </div>
                        
                        <div class="form-group">
                            <label for="banco">Banco:</label>
                            <input type="number" class="form-control" id="bank" name="banco" required="required" pattern=\d{3} placeholder="">
                            <span style="font-size: 0.8rem;">Ex: 290</span>
                        </div>
                        
                        <div class="form-group">
                            <label for="agencia">Agência:</label>
                            <input type="number" class="form-control" id="agency" name="agencia" required="required" max="999999" placeholder="">
                            <span style="font-size: 0.8rem;">Ex: 5554</span>
                        </div>
                        
                        <div class="form-group">
                            <label for="conta_corrente">Conta-corrente:</label>
                            <input type="text" class="form-control" id="accountId" name="conta_corrente" required="required"  pattern=\d{4}-\d{1} placeholder="">
