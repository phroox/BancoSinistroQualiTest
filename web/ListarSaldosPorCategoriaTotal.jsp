        ...
        <div class="container container-lista-grande centralizar">
            ...
            <div class="table-responsive">
                <table class="table table-borderless bg-light">
                    <caption hidden>Somatório do balancete por categoria de cada uma das contas deste usuário.</caption>
                ...
                <table class="table table-borderless bg-light">
                    <caption>Somatório do balancete por categoria de cada uma das contas deste usuário.</caption>
                    <thead class="thead-light">
                    <tr>
