                ...
                <div class="container container-forms">
                    ...
                    <form method="POST" action="Login">
                        <div class="form-group mb-2">
                            ...
                            <input type="text" class="form-control" required name="cpf" required="required" pattern="\d{3}\.\d{3}\.\d{3}-\d{2}" placeholder="">
                            <span style="font-size: 0.8rem;">Exemplo de valor válido: 888.888.888-88</span>
                        </div>
                        
                        <div class="form-group mb-4">
                            <label for="nome_conta">Sua senha:</label>
                            <input type="password" class="form-control" required name="senha" placeholder="">
                        </div>
