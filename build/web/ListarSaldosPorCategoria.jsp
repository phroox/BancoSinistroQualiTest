                ...
                <div class="container container-lista-grande centralizar">
                    ...
                    <div class="table-responsive">
                        <table class="table table-borderless bg-light">
                            <caption>Balancete da conta deste usuário no banco <%=aux.getNomeConta()%>.</caption>
                            <hr><h2 style="background-color: rgb(201, 201, 201); color: black;">Conta: <%=aux.getNomeConta()%> - Saldo: <%=usuariodao.getSaldoContas(id_usu, aux.getId())%></h2>
