...
<html lang="pt-br">
    <head>
        ...
        <title>Usuário suspenso com sucesso!</title>
    </head>
    <body>
            ...
            <div class="container container-texto">
                ...
                <div class="container container-home centralizar">
                    <div class="d-flex flex-row justify-content-center align-items-center">
                        <h2>Usuário suspenso com sucesso!</h2>
                    </div>
                    <hr>
                    <a href="/BancoSinistro/homeAdmin.jsp" class="btn btn-primary btn">Voltar à página principal</a>
                    <a href="/BancoSinistro/SuspenderUsuario.jsp" class="btn btn-primary btn">Suspender novamente</a>
                </div>
            </div>
        </div>
