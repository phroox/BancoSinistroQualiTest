                ...
                <div class="container container-forms">
                    ...
                    <form method="POST" action="CadastrarUsuario" >
                        ...
                        <div class="form-group mb-2">
                            ...
                            <input type="text" class="form-control" id="cpf" name="cpf" required="required" pattern="\d{3}\.\d{3}\.\d{3}-\d{2}" placeholder="">
                        ...
                        <div class="d-flex flex-row justify-content-center align-items-center">
                            <button type="submit" id="saveUser" class="btn btn-primary" style="background-color: green;">Confirmar</button>
                        </div>
                    </form>         
                </div>
