...
<html lang="pt-br">
    <head>
        ...
        <title>Erro ao cadastrar administrador</title>
    </head>
    <body>
            ...
            <div class="container container-texto">
                ...
                <div class="container container-home centralizar">
                    ...
                    <div class="d-flex flex-row justify-content-center align-items-center m-3">
                        <h4>Não foi possível concluir este cadastro, pois já existe um administrador com o CPF inserido.</h4>
                    </div>
                    <a href="/BancoSinistro/homeAdmin.jsp" class="btn btn-primary btn">Voltar à página principal</a>
                    <a href="/BancoSinistro/CadastroAdmin.jsp" class="btn btn-primary btn">Voltar</a>
                </div>
            </div>
        </div>
