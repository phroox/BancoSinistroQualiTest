            ...
            <div class="container container-texto">
                ...
                <div class="container container-home centralizar">
                    ...
                    <div class="d-flex flex-row justify-content-center align-items-center m-3">
                        <h4>Não foi possível concluir esta edição, pois o banco da conta inserida já possui cadastrada uma conta utilizando a agência e a conta-corrente que foram inseridos.</h4>
                    </div>
